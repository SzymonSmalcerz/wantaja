let LoadState = {
  ...
  preload : function() {
    ...
    this.load.spritesheet("Mahmud", "assets/npc/normal/Mahmud.png", 32, 50);
    ...
    this.load.spritesheet("Lidia", "assets/npc/normal/Lidia.png", 32, 56);
    this.load.spritesheet("Shura", "assets/npc/normal/Shura.png", 32, 56);
    this.load.spritesheet("Tamara", "assets/npc/normal/Tamara.png", 32, 56);
    ...
    this.load.spritesheet("Cavian", "assets/npc/normal/Cavian.png", 32, 56);
